                                        ...
                                        <div class="col-xl-11">
                                            <div class="update-form-container">
                                                <div class="d-flex align-items-center mb-4 border-bottom pb-3"
                                                    ...
                                                    <h3 class="m-0" style="font-weight: 800;">Chỉnh sửa thông tin sản
                                                        phẩm</h3>
                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="input-group has-validation">
                                                                    <form:input type="text" id="priceInput"
                                                                        class="form-control price-field ${not empty errorPrice ? 'is-invalid' : ''}"
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="image-preview-wrapper">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <p class="small text-muted mt-3">Chọn tệp mới nếu bạn

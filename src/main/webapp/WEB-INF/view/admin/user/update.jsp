                        ...
                        <div class="col-xl-10">
                            <div class="update-form-container">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="icon-box me-3" style="background: rgba(255, 202, 40, 0.1); padding: 10px; border-radius: 12px;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 text-center mb-4 mb-lg-0">
                                            <div class="avatar-upload-section h-100">
                                                ...
                                                <img src="/images/avatar/${newUser.avatar}" alt="avatar preview" id="avatarPreview">
                                                <input class="form-control form-control-sm" type="file" id="avatarFile"
                                                    accept=".png, .jpg, .jpeg" name="phucvietFile" />
                                                <p class="small text-muted mt-2">Định dạng hỗ trợ: PNG, JPG, JPEG</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form:input type="email" class="form-control" path="email" placeholder="example@gmail.com" />
                                                </div>
                                                
                                                <div class="col-md-6">
                                                    <label class="form-label">Phone Number</label>
                                                    <form:input type="text" class="form-control" path="phone" placeholder="0123 456 789" />
                                                </div>

                                                <div class="col-md-12">
                                                    <label class="form-label">Full Name</label>
                                                    <form:input type="text" class="form-control" path="fullName" placeholder="Nguyen Van A" />
                                                </div>

                                                <div class="col-md-12">
                                                    <label class="form-label">Password</label>
                                                    <form:input type="password" class="form-control" path="password" />
                                                    <small class="text-muted"><i class="fas fa-info-circle me-1"></i>Để trống nếu không muốn thay đổi mật khẩu.</small>
                                                </div>

                                                <div class="col-md-8">
                                                    <label class="form-label">Address</label>
                                                    <form:input type="text" class="form-control" path="address" placeholder="123 Street, District..." />
                                                </div>

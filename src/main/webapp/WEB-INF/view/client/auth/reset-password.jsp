    ...
    <div class="login-container">
        <section class="login-form-section">
            <div class="login-box">
                ...
                <p class="text-muted small mb-4">Vui lòng nhập mật khẩu mới để hoàn tất việc khôi phục tài khoản.</p>
        ...
        <section class="login-image-section d-none d-lg-block">
            <div class="h-100 w-100 d-flex flex-column justify-content-end p-5 text-white"
                ...
                <p class="opacity-75">Sử dụng mật khẩu mạnh để tăng cường tính bảo mật cho thông tin cá nhân của bạn tại LaptopShop.</p>
            </div>
        </section>
    </div>
